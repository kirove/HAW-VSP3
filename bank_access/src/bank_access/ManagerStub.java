...
/**
 * Extends bank_access.ManagerImplBase is a IStub responsible for the communication with the server side using serialized Objects
 */
public class ManagerStub extends ManagerImplBase implements IStub {
